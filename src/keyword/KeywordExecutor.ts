...
import { createDefaultKeywordRegistry } from "./KeywordRegistry";
import { KeywordScenario } from "./types";

export class KeywordExecutor {
  constructor(
    private readonly kernel = new AutomationKernel(),
    private readonly registry = createDefaultKeywordRegistry()
  ) {}
